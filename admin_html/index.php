                    ...
                    <div id="tabs-presentations">
                        ...
                        <div class="tabs">
                            ...
                            <div id="tabs-pres-1">
                                <table>
                                    <tr>
                                        <th class="name">Display</th>
                                        <th class="path">File Name</th>
                                        <th class="actions">&nbsp;</th>
                                    </tr>
                                    <?php
                                        $stmt = $db_link->prepare ("SELECT " .
                                        ...
                                        while ($stmt->fetch ()) {
                                            ...
                                            echo "<td class='path'>$pres_path</td>\n";
                                            echo "<td class='actions'>\n";
                                            echo "<input type='hidden' value='$id' />\n";
                                            echo "<ul class='icons-edit-buttons ui-widget ui-helper-clearfix'>\n";
                                            echo "<li class='edit ui-state-default ui-corner-all presentation-file-delete' title='Delete'>\n";
                                            echo "<span class='ui-icon ui-icon-trash'></span>\n";
                                            echo "</li>\n";
                                            echo "</ul>";
                                            echo "</td>\n";
                                            echo "</tr>\n";
                            ...
                            <div id="tabs-pres-3">
                                <div class="top10px">
                                    <textarea id="txaPresentationFooter" rows="15" cols="111">
                                        <?php
                                            include ('/home/solaryps/content/presentations_footer.html');
                                        ?>
                                    </textarea>
                                </div>
                                <div class="top10px centered formRow">
                                    <input type="button" id="btnSavePresentationFooter" value="Save" />
                                    <span id="spnContentPresentationFooterResult"></span>
                                </div>
                            </div>
                            <div id="tabs-pres-2">
                                <table>
                                    <tr>
                                        <th class="name">Display</th>
                                        <th class="path">File Name or URL</th>
                                        <th class="preview">Preview Image Name</th>
                                        <th class="length">Video Length</th>
                                        <th class="actions">&nbsp;</th>
                                    </tr>
                                    <?php
                                        $stmt = $db_link->prepare ("SELECT " .
                                        ...
                                        while ($stmt->fetch ()) {
                                            ...
                                            echo "<td class='name'>$title</td>\n";
                                            echo "<td class='path'>$pres_path</td>\n";
                                            echo "<td class='preview'>$preview_image_path</td>\n";
                                            echo "<td class='length'>$video_length</td>\n";
                                            echo "<td class='actions'>\n";
                                            echo "<input type='hidden' value='$id' />\n";
                                            echo "<ul class='icons-edit-buttons ui-widget ui-helper-clearfix'>\n";
                                            echo "<li class='edit ui-state-default ui-corner-all presentation-file-delete' title='Delete'>\n";
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <ul class="icons-edit-buttons ui-widget ui-helper-clearfix">
                                                    <li class="edit ui-state-default ui-corner-all cron-edit" title="Edit">
